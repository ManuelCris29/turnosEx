...
|---|---|
| **[deployment](./05-referencia/deployment/)** | **Despliegue en AWS**: [checklist EC2+RDS+SES](./05-referencia/deployment/CHECKLIST_DESPLIEGUE_AWS_RDS.md), [arquitectura recomendada](./05-referencia/deployment/arquitectura-aws-rds-recomendada.md), manual EC2, plan de correo transaccional. |
