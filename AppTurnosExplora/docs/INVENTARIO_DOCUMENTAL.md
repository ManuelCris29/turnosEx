...
| Despliegue | completo | [05-referencia/deployment/](./05-referencia/deployment/) | **Vigente: [CHECKLIST_DESPLIEGUE_DOKPLOY.md](./05-referencia/deployment/01-dokploy/CHECKLIST_DESPLIEGUE_DOKPLOY.md)** (2026-09-09) + [MANUAL_CORREO_GOOGLE_WORKSPACE.md](./05-referencia/deployment/02-correo/MANUAL_CORREO_GOOGLE_WORKSPACE.md), que sustituyen al plan de AWS (conservado como registro de invariantes). Ademas AWS EC2+RDS, Fargate y Docker local. Incluye [MANUAL_ARCHIVADO_ANUAL.md](./05-referencia/deployment/03-operacion/MANUAL_ARCHIVADO_ANUAL.md) (2026-09-03): analiza el borrado anual de datos y lo **descarta**; queda pendiente solo el dump anual a S3 | 
