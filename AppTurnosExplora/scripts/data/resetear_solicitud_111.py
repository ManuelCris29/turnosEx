"""
Script para resetear la solicitud de doblada 111 a estado pendiente.
Permite volver a aprobar la solicitud para que se generen correctamente los turnos.
"""
import os
import sys
import django
...
print("=" * 80)
print("RESETEAR SOLICITUD 111")
print("=" * 80)

try:
    with transaction.atomic():
        solicitud = SolicitudCambio.objects.select_for_update().get(id=111)
        ...
        print("=" * 80)
        print("1. Marco debe aprobar la solicitud nuevamente")
