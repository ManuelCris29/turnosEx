...
from .views import (
    ...
    DescansosSemanaUsuarioView,
    DFDSCompanerosView,
    DiasDisponiblesDobladaPermanenteView,
    DobladasSemanaView,
    ExploradoresConDobladaView,
    GestionCancelarSolicitudView,
    GestionEliminarSolicitudView,
